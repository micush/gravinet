...
// freebsdAnchor is a plain gravinet-owned anchor name (FreeBSD has no
// macOS-style default wildcard to nest under — see netfilter_pf_bsdhook.go
// for why we hook it into /etc/pf.conf ourselves instead).
const freebsdAnchor = "gravinet_nat"
...
func New() (*Manager, error) {
	...
	if err := ensureAnchorHook(freebsdAnchor); err != nil {
	...
	return &Manager{anchor: freebsdAnchor, release: release}, nil
}
