...
func (s *Server) handleConfig(w http.ResponseWriter, r *http.Request) {
	...
	// One probe of the host's capabilities, shared with internal/tui's rail
	// gating — see Capabilities' doc comment for why these two clients read
	// the same function rather than each deciding for themselves.
	caps := Capabilities()
